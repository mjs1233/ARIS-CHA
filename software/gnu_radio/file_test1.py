...
class file_test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "file_test1")
        ...
        self.qtgui_time_sink_x_0.set_y_axis(0, 1000)

        self.qtgui_time_sink_x_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0.enable_tags(False)
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 512, 0, 0, "")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/takakura/Projects/ARIS-CHA/software/dsp/res/raw_37_48965__127_07236__1090M__2_4MS__A.bin', False, 0, 0)
...
def main(top_block_cls=file_test1, options=None):
